...
public class HiddenFolder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentDir = new File("/data/data/com.ir_sj.personaldiary/hidden/");
        ...
        addFile.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(HiddenFolder.this);
                alertDialog.setTitle("Create File");
                alertDialog.setMessage("Enter File Name");

                final EditText input = new EditText(HiddenFolder.this);
                ...
                alertDialog.setPositiveButton("Create",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    String rootPath = "/data/data/com.ir_sj.personaldiary/hidden/";
        ...
        addFolder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(HiddenFolder.this,R.style.Theme_AppCompat_Dialog_MinWidth);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                               ...
                               /* File mydir = getDir(String.valueOf(input.getText()), Context.MODE_PRIVATE); //Creating an internal dir;
                                ...
                                File dir = new File("/data/data/com.ir_sj.personaldiary/hidden");
    ...
    protected void onStart() {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null) {
            Intent intent=new Intent(HiddenFolder.this,LoginOptions.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent help_intent=new Intent(HiddenFolder.this, HelpActivity.class);
        Intent dev_intent=new Intent(HiddenFolder.this, DevelopersActivity.class);
        switch(id)
        {
